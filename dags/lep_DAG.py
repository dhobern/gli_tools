...
sciencedirect_articles = PythonOperator(
   ...
   op_kwargs = { 
       "feeds": [
         { "name": "Journal of Asia-Pacific Entomology", "shortname": "apentom", "rss": "https://rss.sciencedirect.com/publication/science/12268615" },
         { "name": "Journal of Asia-Pacific Biodiversity", "shortname": "apbiodiv", "rss": "https://rss.sciencedirect.com/publication/science/2287884X" }
      ]
   },
   dag=dag,
)
...
bioone_articles = PythonOperator(
   ...
   op_kwargs = { 
       "journals": [
         { "name": "Annales Zoologici", "shortname": "az", "urlname": "annales-zoologici" },
         { "name": "Annals of the Entomological Society of America", "shortname": "esa", "urlname": "annals-of-the-entomological-society-of-america" },
         { "name": "The Canadian Entomologist", "shortname": "canent", "urlname": "the-canadian-entomologist" },
         { "name": "Entomologica Americana", "shortname": "americana", "urlname": "entomologica-americana" },
         { "name": "Entomological News", "shortname": "entnews", "urlname": "entomological-news" },
         { "name": "Florida Entomologist", "shortname": "florent", "urlname": "florida-entomologist" },
         { "name": "Insect Systematics and Diversity", "shortname": "isd", "urlname": "insect-systematics-and-diversity" },
         { "name": "Journal of the Kansas Entomological Society", "shortname": "jks", "urlname": "journal-of-the-kansas-entomological-society" },
         { "name": "The Journal of the Lepidopterists' Society", "shortname": "jls", "urlname": "the-journal-of-the-lepidopterists-society", "filter": False },
         { "name": "The Pan-Pacific Entomologist", "shortname": "ppe", "urlname": "the-pan-pacific-entomologist" },
         { "name": "Proceedings of the Entomological Society of Washington", "shortname": "esw", "urlname": "proceedings-of-the-entomological-society-of-washington" },
         { "name": "Southwestern Entomologist", "shortname": "swent", "urlname": "southwestern-entomologist" },
         { "name": "Transactions of the American Entomological Society", "shortname": "transaes", "urlname": "transactions-of-the-american-entomological-society" }
      ]
   },
   dag=dag,
)
...
[pensoft_articles, sciencedirect_articles, bioone_articles, zootaxa_articles, ecolmont_articles, fareastent_articles, zoonova_articles, biologija_articles, jinsbiod_articles, shilap_articles] >> merge_articles >> format_articles >> lepidoptera_email
