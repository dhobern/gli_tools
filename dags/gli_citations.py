...
def report_citations():
    if os.path.exists(cfg.summary_file):
        ...
        references = pd.read_csv(cfg.reference_file, dtype=str, keep_default_na=False, sep=",")
        ...
        summary = pd.merge(summary, references[["ID", "citation", "modified", "modifiedBy"]], how="left", left_on="referenceID", right_on="ID", suffixes=("", "_r"))
